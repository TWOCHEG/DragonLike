...
public final class RotateUtils {
    ...
    public static void rotate(float yaw, float pitch) {
        rotate(yaw, pitch, mc.getRenderTickCounter().getTickProgress(true));
    }
    ...
    public static float getCameraYaw() {
        return mc.player.getYaw(); // ModuleList.noRotate.isEnabled() ? mc.player.getYaw() : mc.gameRenderer.getCamera().getYaw();
    }

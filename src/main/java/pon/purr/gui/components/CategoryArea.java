...
public class CategoryArea extends RenderArea {
    ...
    public void render(DrawContext context, int startX, int startY, int width, int height, double mouseX, double mouseY) {
        ...
        Render.fill(
            ...
            startX + width,
            (startY + height),
            ColorUtils.fromRGB(0, 0, 0, alpha),
            radius,
            3
        );
        Render.fillPart(
            ...
            startX + width,
            startY + radius,
            ColorUtils.fromRGB(0, 0, 0, 50 * visiblePercent),
            3, true
        );
        ...
        Render.fill(
            ...
            ColorUtils.fromRGB(0, 0, 0, 120 * visiblePercent),
            5,
            2
        );
        context.drawText(
            ...
            nameStartY,
            ColorUtils.fromRGB(255, 255, 255, 180 * visiblePercent),
            false
        );
        context.drawHorizontalLine(startX + nameContainerPadding + 12, startX + width - 20, (modulesStartY - 5), ColorUtils.fromRGB(255, 255, 255, 50 * visiblePercent));

    ...
    public void render(DrawContext context, int startX, int startY, int width, int height, double mouseX, double mouseY) {
        ...
        if (openPercent > 0) {
            Render.fillPart(
                ...
                startX + width,
                startY + vertexRadius,
                ColorUtils.fromRGB(c, c, c, (50 + (40 * hoverPercent)) * category.visiblePercent),
                2,
                true
            );
            context.fill(
        ...
        context.drawText(
            ...
            startY + padding,
            ColorUtils.fromRGB(255, 255, 255, 200 * category.visiblePercent),
            false
        );
        if (enablePercent > 0) {
            context.drawHorizontalLine(
                ...
                ColorUtils.fromRGB(255, 255, 255, 200 * category.visiblePercent * enablePercent)
            );
        }
